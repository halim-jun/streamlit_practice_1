...
with st.sidebar:
    ...
    st.sidebar.info(
        """
        This web [app](https://share.streamlit.io/halim-jun/streamlit_practice_1) 
        is maintained by [HaLim Jun].         
        Inspired by Source code: <https://github.com/giswqs/streamlit-template>
